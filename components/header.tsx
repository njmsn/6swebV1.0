...
export const Header: React.FC = () => {
  ...
  const handleThemeChange = (theme: typeof themes[0]) => {
    ...
    if (theme.isLightSidebar) {
      ...
      root.style.setProperty('--sidebar-text', '#64748b'); // 浅色背景使用深灰色文字
      ...
      root.style.setProperty('--sidebar-text', '#ffffff'); // 深色背景（紫色主题）使用纯白色文字
    ...
    <header className="h-16 bg-white border border-slate-100 rounded-xl px-8 flex items-center justify-between shadow-sm shrink-0 relative z-[100]">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="relative group flex items-center h-full">
          ...
          <div className="absolute top-full right-[-10px] w-[260px] pt-3 z-[9999] opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none group-hover:pointer-events-auto translate-y-2 group-hover:translate-y-0">
            <div className="bg-white rounded-2xl shadow-[0_20px_50px_-10px_rgba(0,0,0,0.12)] border border-slate-100 py-6 px-6 space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex flex-col space-y-1">
                    <span className="text-[12px] font-normal text-slate-500 leading-none">客服微信</span>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex flex-col space-y-1">
                    <span className="text-[12px] font-normal text-slate-500 leading-none">QQ客服</span>
                    <span className="text-[14px] font-normal text-slate-700 tracking-tight">604038645</span>
                  </div>
                </div>
                <div className="relative group/qr w-10 h-10 rounded border border-slate-100 bg-slate-50 p-0.5 shrink-0 ml-2 cursor-zoom-in">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex flex-col space-y-1">
                  <span className="text-[12px] font-normal text-slate-500 leading-none">客服电话:</span>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex flex-col space-y-1.5">
                  <span className="text-[12px] font-normal text-slate-500 leading-none">工作时间</span>
                  <span className="text-[12px] font-normal text-slate-500 tracking-tight leading-tight">周一 - 周五 (08:30-17:30)</span>
                </div>
              </div>
            </div>
          </div>
